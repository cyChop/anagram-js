...
(function (exports) {
    ...
    var DEFAULT_DIACRITICS_REMOVAL_MAP = Object.freeze([
        {
            base: 'A',
    ...
    for (var i = 0; i < DEFAULT_DIACRITICS_REMOVAL_MAP.length; i++) {
        ...
        for (var j = 0; j < letters.length; j++) {
            diacriticsMap[letters.charAt(j)] = DEFAULT_DIACRITICS_REMOVAL_MAP[i].base;
        }
    }
    ...
    var diff = function (src, prop) {
        ...
        for (var propP in mapP) {
            if (mapP[propP] !== 0) {
                if ({}.hasOwnProperty.call(result, propP)) {
    ...
    var map = function (str) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            if ({}.hasOwnProperty.call(result, letter)) {
                result[letter]++;
            } else {
                result[letter] = 1;
            }
     ...
     *
     * @param {boolean} removeDiacritics - <code>true</code> if diacritics should be removed,
     *         <code>false</code> otherwise (default = <code>true</code>).
     * @param {string} original - The original string.
     * @param {string} proposition - The anagram proposition.
     * @return {Checker} A checker
     * @see {@link Checker}
     */
    exports.checker = function (removeDiacritics, original, proposition) {
        return new exports.Checker(removeDiacritics, original, proposition);
    };
     ...
     */
    exports.Checker = function (removeDiacritics, original, proposition) {
        this.stripDiacritics = typeof removeDiacritics === 'undefined' || removeDiacritics;
     ...
     * @param {boolean} removeDiacritics - <code>true</code> if diacritics should be removed,
     *         <code>false</code> otherwise (default = <code>true</code>).
     * @return {Checker} The current instance
     */
    exports.Checker.prototype.updateStripDiacritics = function (removeDiacritics) {
        var strip = typeof removeDiacritics === 'undefined' || removeDiacritics;
     ...
     *
     * @return {Object} An object containing the characters as properties and their cardinality as
     *         values
     */
     ...
     * original string.
     *
     * @return {boolean} <code>true</code> if the current proposition is an anagram of the original
